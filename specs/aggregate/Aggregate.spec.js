...
describe('When dispatchEvents is called', () => {
    it('should dispatch all events to the event bus', () => {
        ...
        expect(firstMessage).toEqual(`[2024-01-28T01:06:59.782Z] Event "USER_NAME_UPDATED" occurred with ID "266e27fe-1c3f-4be6-8646-358e830544d4". Metadata: {"userId":"15e4c6b3-0b0a-4b1a-9b0a-9b0a9b0a9b0a","newName":"Jane Doe"}`);
